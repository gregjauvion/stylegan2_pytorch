...
if __name__=='__main__':
    ...
    # Compute the metrics
    #run_metrics('models/jfr_paris_filtered/checkpoints/7000_2020-11-09_18-40-59/Gs.pth', 'models/jfr_paris_filtered/metrics/7000', '/home/gregoire/data/jfr_paris_filtered_augmented_256', 5000)
    #run_metrics('models/jfr_paris_filtered/checkpoints/7500_2020-11-09_20-12-45/Gs.pth', 'models/jfr_paris_filtered/metrics/7500', '/home/gregoire/data/jfr_paris_filtered_augmented_256', 5000)
    output_dir = 'models/jfr_paris_filtered/metrics'
    compute_metrics(start_model_path, 'models/jfr_paris_filtered/checkpoints', output_dir, '/home/gregoire/data/jfr_paris_filtered_augmented_256', 5000, sampling=1, gpu=True)
